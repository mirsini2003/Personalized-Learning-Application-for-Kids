...
{
    public partial class ActivityAll : Form
    {
        ...
        public ActivityAll(string username, string password)
        {
            InitializeComponent();
        ...
        private void ActivityAll_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void δΡΑΣΤΗΡΙΟΤΗΤΕΣToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void createtest(int difficulty)
        {
            ...
            string query = "SELECT * FROM Questions WHERE Chapter=4 AND Difficulty = " + difficulty.ToString();
        ...
        private void ActivityAll_Load(object sender, EventArgs e)
        {
            ...
            conn = new SQLiteConnection(connectionString);
            conn.Open();
            string query = "SELECT * FROM test_results WHERE chapter = 4 AND student= '" + username + "'";
            cmd = new SQLiteCommand(query, conn);
            reader = cmd.ExecuteReader();
        ...
        private void submit_btn_Click(object sender, EventArgs e)
        {
            ...
            conn = new SQLiteConnection(connectionString);
            conn.Open();
            string insertQuery = "INSERT INTO test_results (student, chapter, date, difficulty, score) VALUES (@name, 3, @date, @diff, @score)";
            ...
            using (SQLiteCommand insertCmd = new SQLiteCommand(insertQuery, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    MessageBox.Show("All responses were recorded.", "Success");
                }
            }
            conn.Close();
