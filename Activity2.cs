...
namespace ergasia_logismikou
{
    public partial class Activity2 : Form
    {
        ...
        public Activity2(string username, string password)
        {
            InitializeComponent();
        ...
        private void Activity2_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string query = "SELECT * FROM test_results WHERE chapter = 2 AND student= '" + username + "'";
        ...
        private void createtest(int difficulty)
        {
            ...
            string query = "SELECT * FROM Questions WHERE Chapter=2 AND Difficulty = " + difficulty.ToString();
            cmd = new SQLiteCommand(query, conn);
            reader = cmd.ExecuteReader();
     ...
     // clear
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Άπαντήστε σωστά στην προηγούμνη δυσκολία πρώτα");
            }
            else
            {
                label2.Hide();
        ...
        private void submit_btn_Click(object sender, EventArgs e)
        {
            ...
            conn = new SQLiteConnection(connectionString);
            conn.Open();
            string insertQuery = "INSERT INTO test_results (student, chapter, date, difficulty, score) VALUES (@name, 2, @date, @diff, @score)";
        ...
        private void Activity2_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
