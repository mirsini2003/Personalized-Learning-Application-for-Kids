...
namespace ergasia_logismikou
{
    public partial class Activity3 : Form
    {
        ...
        public Activity3(string username, string password)
        {
            InitializeComponent();
        ...
        private void Activity3_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string query = "SELECT * FROM test_results WHERE chapter = 3 AND student= '" + username + "'";
        ...
        private void Activity3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void createtest(int difficulty)
        {
            ...
            string query = "SELECT * FROM Questions WHERE Chapter=3 AND Difficulty = " + difficulty.ToString();
            cmd = new SQLiteCommand(query, conn);
            reader = cmd.ExecuteReader();
        ...
        private void submit_btn_Click(object sender, EventArgs e)
        {
            ...
            using (SQLiteCommand insertCmd = new SQLiteCommand(insertQuery, conn))
            {
                ...
                if (rowsAffected > 0)
                {
                    MessageBox.Show("All responses have been recorded.", "Success");
                }
            }
            conn.Close();
            ...
            {
                pictureBox1.Image = Properties.Resources.congrats1;
            }
            correct = 0;
            right.Clear();
            wrong.Clear();
